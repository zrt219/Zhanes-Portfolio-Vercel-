...
export const evidenceSources: EvidenceSource[] = [
  {
    ...
    detail: "Stores the contiguous May 1 to September 21 workflow-event history, daily deltas, and session counts.",
  },
  {
    id: "daily-report",
    ...
    sourceHref: `${githubBlobBase}/evidence/public/daily-evidence-report-2026-09-21.md`,
